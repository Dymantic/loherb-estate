...
<section class="banner flex justify-center items-center">
    @include('svgs.logos.sites.logo_estate', ['classes' => 'h-32 md:h-48'])
    <a href="#" data-banner-jump="" class="absolute pin-b hidden md:inline text-cream-light hover:text-gold"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="50px" height="50px" class="fill-current"><path d="M15.3 9.3a1 1 0 0 1 1.4 1.4l-4 4a1 1 0 0 1-1.4 0l-4-4a1 1 0 0 1 1.4-1.4l3.3 3.29 3.3-3.3z"></path></svg></a>
</section>
    <section class="py-20 px-8 flex flex-col items-center first-section">
    ...
    <footer class="flex flex-col py-12 items-center bg-blue-main text-white">
